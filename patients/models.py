...
class PatientCase(BaseModel):
    ...
    patient = models.ForeignKey(InputLog, on_delete=models.SET_NULL, null=True, verbose_name=_('Patient'))
    ...
    representor = models.CharField(max_length=255, blank=True, verbose_name=_('Representor'))
    representor_relation = models.CharField(max_length=255, blank=True, verbose_name=_('Representor Relation'))
    representor_phone = models.CharField(max_length=20, blank=True, verbose_name=_('Representor Phone'))
...
class LivelihoodAssessment(BaseModel):
    ...
    deposit_amount = models.IntegerField(default=0, verbose_name=_('Deposit Amount'))
    rent_amount = models.IntegerField(default=0, verbose_name=_('Rent Amount'))
    ...
    other_monthly_income = models.IntegerField(default=0, verbose_name=_('Other Monthly Income'))
    ...
    helper_assessment = models.TextField(blank=True, verbose_name=_('Helper Assessment'))
...
class Relative(models.Model):
    ...
    monthly_income = models.IntegerField(verbose_name=_('Monthly Income'))
    health_status = models.TextField(blank=True, verbose_name=_('Health Status'))
...
class OtherSupporter(models.Model):
    ...
    support_count = models.IntegerField(default=0, verbose_name=_('Support Count'))
    description = models.TextField(blank=True, verbose_name=_('Description'))
...
class ApplicationSupport(models.Model):
    ...
    multiple_receive = models.BooleanField(null=True, verbose_name=_('Multiple Receive'))
    is_active = models.BooleanField(null=True, verbose_name=_('Active'))
    first_intake_date = jmodels.jDateField(verbose_name=_('First Intake Date'))
    prescription_cost = models.IntegerField(verbose_name=_('Prescription Cost'))
...
class SupportProgram(models.Model):
    ...
    program_type = models.CharField(max_length=255, verbose_name=_('Program Type'))
...
class PatientHelperHistory(BaseModel):
    ...
    patient_description = models.TextField(verbose_name=_('Patient Description'))
